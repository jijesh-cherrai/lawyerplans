        ...
        if ($request->ajax()) {
            ...
            return datatables()->of($data)
                ->addColumn('actions', function ($row) {
                    $editBtn = '<button type="button" class="btn btn-primary btn-sm editCourtButton" data-id="' . $row->id . '">Edit</button>';
                    $deleteBtn = '<button type="button" class="btn btn-danger btn-sm deleteCourtButton" data-id="' . $row->id . '">Delete</button>';
