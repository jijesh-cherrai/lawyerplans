...
Route::get('/case-diaries/edit/{id}', [CaseDiaryController::class, 'edit'])->name('case-diaries.edit');
Route::delete('/case-diaries/destroy/{id}', [CaseDiaryController::class, 'destroy'])->name('case-diaries.destroy');
