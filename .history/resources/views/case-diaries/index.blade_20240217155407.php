...
@section('js')
    ...
    columns: [
        ...
        { data: 'court.court_name', name: 'court.court_name' },
        { data: 'party_names', name: 'party_names' },
        { data: 'case_date', name: 'case_date' },
        { data: 'purpose', name: 'purpose' },
        { data: 'opposit_lawyer', name: 'opposit_lawyer', visible: false }, // Hide opposit_lawyer column
        { data: 'notes', name: 'notes', visible: false }, // Hide notes column
        { data: 'actions', name: 'actions', orderable: false, searchable: false }
    ],
    order: [ [3, 'desc'] ] // Default ordering by case_date
});
