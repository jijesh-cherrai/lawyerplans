    ...
    <script>
        $(document).ready(function() {
            ...
            $('#caseDiaries-table').DataTable({
                ...
                columnDefs: [
                    { responsivePriority: 1, targets: 0 }, // Case Number
                    { responsivePriority: 2, targets: 1 }, // Court
                    { responsivePriority: 3, targets: 2 }, // Party Names
                    { responsivePriority: 4, targets: 3 }, // Case Date
                    { responsivePriority: 5, targets: 4 }, // Purpose
                    { responsivePriority: 6, targets: 5 }, // Opposit Lawyer
                    { responsivePriority: 7, targets: 6, visible: false }, // Notes
                    { responsivePriority: 8, targets: 7, visible: false }  // Actions
                ],
                order: [
                    [3, 'desc']
                ]
