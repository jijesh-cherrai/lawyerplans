            ...
            $('#caseDiaries-table').DataTable({
                responsive: {
                    details: {
                        ...
                        target: '0' // Apply the child row to the table row
                    },
                ...
                columns: [
                    { 
                        ...
                        render: function(data, type, row, meta) {
                            // Custom rendering for the first column with control for child rows
                            return '<span class="details-control"></span>' + data.case_number;
                        }
                    },
