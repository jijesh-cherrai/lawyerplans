                ...
                <div class="card">
                    ...
                    <div class="card-body col-md-12">
                        ...
                        <div class="table-responsive ml-1">
                            <table id="caseDiaries-table" class="table table-sm table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>Case Number</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#caseDiaries-table').DataTable({
                responsive: {
                    details: {
                        type: 'column', // Show child row in a column
                        target: 'tr' // Apply the child row to the table row
                    },
                    renderer: function(api, rowIdx, columns) {
                        var data = $.map(columns, function(col, i) {
                            return col.hidden ?
                                ...
                                col.columnIndex + '">' +
                                '<td>' + col.title + ':' + '</td> ' +
                                '<td><div class="text-wrap">' + col.data + '</div></td>' +
                                '</tr>' :
                                '';
                        }).join('');
                ...
                columnDefs: [{
                    ...
                    {
                        "targets": [-2, -3], // Index of the second-to-last and third-to-last columns
                        "responsivePriority": 1, // Set responsive priority to 1
                        "className": "none" // Hide columns if there is not enough space
                    }
                ],
                columns: [{
                        data: null,
